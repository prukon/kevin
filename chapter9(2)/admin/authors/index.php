...
include_once $_SERVER['DOCUMENT_ROOT'] .
    '/chapter9(2)/includes/magicquotes.inc.php';

require_once $_SERVER['DOCUMENT_ROOT'] . '/chapter9(2)/includes/access.inc.php';
...
if (isset($_GET['add']))
{
  include $_SERVER['DOCUMENT_ROOT'] . '/chapter9(2)/includes/db.inc.php';
